...
public class Client {
    ...
    public Client(String clientName, String clientSurname, String clientAddress, Integer spent, String clientPhone) {
        this.clientName = clientName;
...
//    }
    ...
    public Calendar getClientOrderDate() {
